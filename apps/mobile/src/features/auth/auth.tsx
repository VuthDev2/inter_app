...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  // Locally stored conversations and recordings are namespaced by account.
  // Without this they belonged to whoever used the device last: sign out, sign
  // in as someone else, and History showed the previous account's data.
  useEffect(() => {
