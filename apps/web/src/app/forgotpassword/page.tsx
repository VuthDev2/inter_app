...
export default function ForgotPasswordPage() {
    ...
    const { sendOTP, initialized } = useAuth();
        ...
        <div className="flex min-h-screen bg-gradient-to-r from-white via-blue-100 to-blue-600 font-sans text-slate-900 overflow-hidden relative">
            ...
            <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 relative z-10">
                <div className="w-full max-w-[480px] bg-[#fafafa] rounded-[2rem] p-10 sm:p-12 shadow-2xl relative z-10 animate-in slide-in-from-bottom-8 fade-in duration-700">
                    ...
                    <p className="text-sm font-bold text-slate-600 mt-2 mb-10">No worries, we'll send your reset instructions</p>
                    ...
                    <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                        ...
                        {sent && (
                            <div className="bg-green-50 border border-green-200 text-green-600 text-sm font-semibold rounded-xl px-5 py-3">
                    ...
                    <div className="mt-10 text-center">
                        <span className="text-sm font-semibold text-slate-500">
                            Remember password? <Link href="/login" className="text-blue-600 font-bold hover:text-blue-700 hover:underline transition-colors ml-1">Sign In</Link>
                        </span>
                    </div>
                </div>
            </div>
