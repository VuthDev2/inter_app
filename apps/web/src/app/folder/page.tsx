...
import { ArrowLeft, Clock, ArrowLeftRight, CheckSquare, Square, Pencil, Trash2, X, Mic } from "lucide-react";
...
export default function FolderPage() {
    ...
    const confirmDelete = () => {
        setRecords(prev => prev.filter((_, i) => !itemsToDelete.includes(i)));
        setSelectedItems([]);
