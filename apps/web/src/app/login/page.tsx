...
export default function LoginPage() {
    ...
    const { signIn, signInWithGoogle, signInWithFacebook, user, initialized } = useAuth();
            ...
            <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 relative z-10">
                <div className="w-full max-w-[480px] bg-white rounded-[2rem] p-10 sm:p-12 shadow-2xl relative z-10 animate-in slide-in-from-bottom-8 fade-in duration-700">
                    ...
                    <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col gap-2 group">
                            ...
                            <div className="text-right mt-1">
                                <Link href="/forgotpassword" className="text-sm font-semibold text-blue-500 hover:text-blue-600 transition-colors">Forgot Password?</Link>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <button type="button" onClick={signInWithFacebook} className="w-full bg-[#f4f7fe] hover:bg-[#ebf0fc] text-slate-700 font-bold text-sm rounded-xl py-4 flex items-center justify-center gap-3 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-sm active:translate-y-0">
                    ...
                    <div className="mt-10 text-center">
                        <span className="text-sm font-semibold text-slate-500">
                            Don't have an account? <Link href="/signup" className="text-blue-600 font-bold hover:text-blue-700 hover:underline transition-colors ml-1">Sign Up</Link>
                        </span>
                    </div>
                </div>
            </div>
